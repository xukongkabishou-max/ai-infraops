...
class Settings:
    ...
    mysql_pool_size: int = int(os.getenv("MYSQL_POOL_SIZE", "12"))
    mysql_pool_max_overflow: int = int(os.getenv("MYSQL_POOL_MAX_OVERFLOW", "0"))
    mysql_pool_timeout_seconds: float = float(os.getenv("MYSQL_POOL_TIMEOUT_SECONDS", "5"))
    mysql_pool_recycle_seconds: int = int(os.getenv("MYSQL_POOL_RECYCLE_SECONDS", "300"))
